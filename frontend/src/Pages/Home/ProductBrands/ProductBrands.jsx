  ...
  return (
    <section>
      ...
      <div className="experience__area dark__image section-padding">
        <Image
          className="experience__area-shape dark-n"
          src="assets/img/shape/experience.png"
          alt=""
        />
        <Image
          className="experience__area-shape light-n"
          src="assets/img/shape/experience-dark.png"
          alt=""
        />
        <Container>
          <div className="BrandItem">
            <div className="experience__area-right">
              <div className="experience__area-right-title">
                <span className="subtitle-one">Brand Success</span>
          ...
          <Row className="align-items-center">
            {/* <Col xl={6} lg={6} className="lg-mb-30">
              <div className="experience__area-image">
                <Image className="experience__area-image-shape left-right-animate" src="assets/img/shape/dots.png" alt="" />
                <div className="experience__area-image-item">
                  <Image src="assets/img/pages/experience-1.jpg" alt="" />
                </div>
                <div className="experience__area-image-item mt-65">
                  <Image src="assets/img/pages/experience-2.jpg" alt="" />
                </div>
              </div>
            </Col> */}
          </Row>
          {/* <a className="btn-two" href="request-quote.html">
                  Get Consulting<i className="far fa-chevron-double-right" />
                </a> */}
        </Container>
      </div>
      {/* Experience Area End */}
