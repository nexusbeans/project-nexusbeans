            ...
            <div className="row">
              ...
              <div className="col-md-6 lg-mb-30">
                <div className="request__quote-item">
                  ...
                  <input type="text" defaultValue="https://" required="" />
                </div>
              </div>
              ...
              <div className="col-lg-12">
                ...
                <label>
                  <input className="mr-10" type="radio" />
                  Yes, Please!
                </label>
                <br />
                <label>
                ...
                <p className="description">
                  ...
                  unsubscribe at any time. We respect your privacy and will
                  never share your information.
                </p>
                <button className="btn-one mt-30" type="submit">
                  Submit <i className="far fa-chevron-double-right" />
                </button>
              </div>
            </div>
          </form>
